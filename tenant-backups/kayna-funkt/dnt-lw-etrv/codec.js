var payload_parser_version = [1,3,0];
    ...
    switch(COMMAND_ID[commandId])
    {
      ...
      case "COMMANF_ID_GET_STATUS":
        ...
        if( !!(status_param_tx_enable_reg & (1 << 6)) )
        {
          ...
          idx = idx + 2;			
          data.heating_control.room_temperature.unit = "Â°C";
        }
        ...
        if( !!(status_param_tx_enable_reg & (1 << 5)) )
        {
          ...
          data.heating_control.set_point_temperature.unit = "Â°C";
        }
      ...
      case "COMMAND_ID_GET_HOLIDAY_MODE_CONFIG":
        ...
        data.heating_control.mode.holiday.set_point_temperature.unit = "Â°C";
      break;
      ...
      case "COMMAND_ID_GET_SET_POINT_TEMPERATURE":
        ...
        data.heating_control.mode.manu_temp.unit = "Â°C";
      break;
      ...
      case "COMMAND_ID_GET_WINDOW_OPEN_DETECTION_CONFIG":
        ...
        data.heating_control.mode.window_open_detection.config.open_temperature.unit = "Â°C";
      break;
...
/* Test data */ 
/* Delete everything below to use the payload parser */

const input = 
{
  //"bytes": [0x00, 0x13, 0x02, 0xE4, 0x04, 0xE4, 0xBC, 0x72, 0x19, 0x00, 0x05, 0xBC, 0x06, 0x00, 0x07, 0x00, 0x08, 0x19, 0x89, 0x37, 0xC9, 0x17, 0x38, 0x09, 0x34, 0x52, 0x02, 0x38, 0x59, 0x03, 0x00, 0x0B, 0x00, 0x00, 0x11, 0x00, 0x21, 0x00, 0x21, 0x11, 0x00, 0x00, 0x3C, 0x13, 0x08, 0xA0, 0x15, 0x04, 0x03, 0x3E, 0x64, 0x14, 0x3E, 0x65, 0x09, 0x3E, 0x66, 0xBB, 0x3E, 0x67, 0x17, 0x00, 0x18, 0x00, 0x1A, 0x00, 0x1C, 0xC8, 0x1E, 0x28, 0x20, 0x19, 0x23, 0x80, 0x25, 0x72, 0x26, 0x19, 0x27, 0x80, 0x29, 0x04, 0x1A, 0x64, 0x2B, 0x06, 0x0E, 0x64, 0x2D, 0x00, 0x2F, 0x07, 0x4A, 0x3C, 0x31, 0x62, 0xC0, 0x15, 0x10, 0x37, 0x04, 0x7F, 0x39, 0x01, 0x78, 0x00, 0x7A, 0xA2, 0x38, 0x7F, 0x43, 0x01, 0x00, 0x00, 0x02, 0x09, 0x09, 0x01, 0x00, 0x03, 0x15, 0x20],
  "bytes": [0x04, 0xFC, 0xA1, 0x65, 0x5F, 0x00, 0x04, 0x1A, 0x64, 0x04],
  "fport": 10
}
